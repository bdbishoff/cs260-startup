    ...
    <header>
      ...
      <ul class="nav">
        ...
        <li class="nav-item" id="userID">
          <a class="nav-link" id="changeUser">User ID</a>
        </li>
      </ul>
...
We can use the general sibling combinator to increase the whitespace padding on the left of paragraphs that are siblings of a level two head
...
.nav-link {
    color: #dc3545;
    --bs-nav-link-hover-color: #96000c;
}
...
.btn-primary {
    --bs-btn-bg: #c52938;
    --bs-btn-border-color: #a1101f;
    --bs-btn-hover-bg: #ff5264;
    --bs-btn-hover-border-color: #e63042;
